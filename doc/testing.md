...
phone-named session under `.telegram/sessions/`. Listener and history use that
same authorized session and never request credentials. Set channels, time
ranges, and enrichment options in the constants at the top of each smoke
